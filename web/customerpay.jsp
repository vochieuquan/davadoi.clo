...
<%
    ...
    double standardShippingFee = 30000; // Phí vận chuyển tiêu chuẩn
    double fastShippingFee = 50000;     // Phí vận chuyển nhanh
%>
...
<body>
            ...
            <form id="checkoutForm" action="<%= contextPath %>/order" method="POST" onsubmit="return handleSubmit(event)">
                <div class="checkout-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fullName" id="name" placeholder="Nhập họ và tên" required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function updateShippingFee() {
            ...
            shippingFee = (shippingMethod === "fast") ? <%= fastShippingFee %> : <%= standardShippingFee %>;
            updateTotal();
        }
            ...
            <% for (Discount discount : discounts) { %>
                if (promoCode === "<%= discount.getCode() %>") {
                    ...
                    if (!<%= discount.isActive() %>) {
                        appliedDiscount = 0;
                        alert("Mã giảm giá " + promoCode + " không còn hoạt động!");
